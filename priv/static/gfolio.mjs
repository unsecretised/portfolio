...
var projects = /* @__PURE__ */ toList([
  /* @__PURE__ */ new Project(
    "Gleam",
    "Gleam is a statically typed functional programming language for building fast, scalable web applications.",
    "/assets/projects/gleam.png",
    "https://gleam.run"
  ),
  /* @__PURE__ */ new Project(
    "TailwindCSS",
    "A utility-first CSS framework for rapidly building custom designs.",
    "/assets/projects/tailwindcss.png",
    "https://tailwindcss.com"
  ),
  /* @__PURE__ */ new Project(
    "Lustre",
    "Lustre is a library for building user interfaces in Gleam.",
    "/assets/projects/lustre.png",
    "https://github.com/gleam-lang/lustre"
  )
]);
